  ...
  return (
    <NavigationContainer>
      <Stack.Navigator initialRouteName={isFirstLaunch ? 'Onboarding1' : 'Signup'}>
        ...
        <Stack.Screen
          name="MakeOfferProcessed"
          component={MakeOfferProcessed}
          options={{ headerShown: false }}
        />
        <Stack.Screen
          name="MakeOfferAccepted"
          component={MakeOfferAccepted}
          options={{ headerShown: false }}
        />
        <Stack.Screen
          name="MakeOfferRejected"
          component={MakeOfferRejected}
          options={{ headerShown: false }}
        />
        ...
        <Stack.Screen
          name="TrackOrdersV1"
          component={TrackOrdersV1}
          options={{ headerShown: false }}
        />
        <Stack.Screen
          name="TrackOrdersV2"
          component={TrackOrdersV2}
          options={{ headerShown: false }}
        />
