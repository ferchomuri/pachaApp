...
const Search = ({ navigation }) => {
  ...
  const renderKeywords = () => {
    ...
    return (
      <View>
        <Text style={{ ...FONTS.body3, marginBottom: 6 }}>Busquedas recientes</Text>
        <FlatList
          horizontal={true}
          data={recentKeywords}
  ...
  const renderSuggestedShops = () => {
    ...
    return (
      <View style={{ marginVertical: 8 }}>
        <Text style={{ ...FONTS.body3, marginBottom: 6 }}>Tiendas sugeridas</Text>
  ...
  const renderPopularProducts = () => {
    return (
      <View style={{ marginBottom: 80 }}>
        <Text style={{ ...FONTS.body3, marginBottom: 6 }}>Productos populares</Text>
        <FlatList
          horizontal={true}
          ...
          renderItem={({ item, index }) => (
            ...
            >
              ...
              <Text style={{ fontSize: 13, fontFamily: 'regular' }}>${item.price}</Text>
            </View>
          )}
        />
      </View>
            ...
            >
              ...
              <View>
                ...
                >
                  ...
                  >
                    <Text style={[selectedOffer === 'Delivery' && styles.checkboxText]}>
                      Free Delivery
                    </Text>
                  </TouchableOpacity>
                  ...
                  <TouchableOpacity
                    style={[
                      styles.checkboxContainer,
                      selectedOffer === 'No Fee' && styles.selectedCheckbox,
                    ]}
                    onPress={() => handleOfferSelection('No Fee')}
                  >
                    <Text style={[selectedOffer === 'No Fee' && styles.checkboxText]}>No Fee</Text>
                  </TouchableOpacity>
                  <TouchableOpacity
                    style={[
                      styles.checkboxContainer,
                      selectedOffer === 'Reward Points' && styles.selectedCheckbox,
                    ]}
                    onPress={() => handleOfferSelection('Reward Points')}
                  >
                    <Text style={[selectedOffer === 'Reward Points' && styles.checkboxText]}>
                      Reward Points
                    </Text>
                  </TouchableOpacity>
                </View>
              ...
              <View>
                ...
                >
                  <TouchableOpacity
                    style={[
                      styles.checkboxContainer,
                      selectCondition === 'All' && styles.selectedCheckbox,
                    ]}
                    onPress={() => handleConditionSelection('All')}
                  >
                    <Text style={[selectCondition === 'All' && styles.checkboxText]}>All</Text>
                  </TouchableOpacity>

                  <TouchableOpacity
                    style={[
                      styles.checkboxContainer,
                      selectCondition === 'New' && styles.selectedCheckbox,
                    ]}
                    onPress={() => handleConditionSelection('New')}
                  >
                    <Text style={[selectCondition === 'New' && styles.checkboxText]}>New</Text>
                  </TouchableOpacity>

                  <TouchableOpacity
                    style={[
                      styles.checkboxContainer,
                      selectCondition === 'Used' && styles.selectedCheckbox,
                    ]}
                    onPress={() => handleConditionSelection('Used')}
                  >
                    <Text style={[selectCondition === 'Used' && styles.checkboxText]}>Used</Text>
                  </TouchableOpacity>
                </View>
              </View>
