          ...
          <View style={styles.subContainer}>
            <View style={styles.subLeftContainer}>
              ...
              <View style={{ flexDirection: 'column' }}>
                ...
                <Text style={styles.textBody}>2464 Royal Ln. Mesa, New Jersey 45463</Text>
              </View>
            </View>
          ...
          <View style={styles.subContainer}>
            <View style={styles.subLeftContainer}>
              ...
              <View style={{ flexDirection: 'column' }}>
                ...
                <Text style={styles.textBody}>3891 Ranchview Dr. Australia</Text>
              </View>
            </View>
