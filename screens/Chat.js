      ...
      <View style={styles.contentContainer}>
        <View style={styles.header}>
          <TouchableOpacity onPress={() => navigation.goBack()}>
            <Image source={icons.arrowLeft} resizeMode="contain" style={styles.headerIcon} />
          </TouchableOpacity>
          <TouchableOpacity>
            <Image source={icons.more} resizeMode="contain" style={styles.headerIcon} />
          </TouchableOpacity>
        </View>
        <View style={styles.userInfoContainer}>
          <View style={styles.userInfo}>
            <Image source={images.avatar7} resizeMode="contain" style={styles.userAvatar} />
          ...
          <View style={styles.actions}>
            <TouchableOpacity onPress={() => navigation.navigate('Call')} style={styles.actionIcon}>
