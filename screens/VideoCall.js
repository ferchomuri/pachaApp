...
const VideoCall = ({ navigation }) => {
  ...
  return (
    <ImageBackground style={{ flex: 1 }} source={images.user3}>
      <View style={styles.bottomContainer}>
        <View style={styles.actionContainer}>
          <TouchableOpacity style={styles.btnContainer} onPress={() => setIsMute(!isMute)}>
      ...
      <View style={styles.callerContainer}>
        <Image source={images.avatar3} resizeMode="contain" style={styles.callerAvatar} />
      </View>
      <View style={styles.doctorInfoContainer}>
        ...
        >
          <View style={[styles.timeContainer, { marginRight: 12 }]} />
