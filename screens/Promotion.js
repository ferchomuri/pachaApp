    ...
    return (
      <View>
        <View style={styles.titleContainer}>
          <Text style={[styles.subtitle, { marginRight: 8 }]}>Limited time</Text>
        ...
        <View style={styles.promoCodeContainer}>
          <View style={styles.priceTagContainer}>
            <Image source={icons.ticket} resizeMode="contain" style={styles.ticketIcon} />
          </View>
          <View style={{ flexDirection: 'column' }}>
            <Text style={styles.code}>HLWN40</Text>
            <Text style={styles.codeBody}>Use this coupon to get 30% off on your transaction</Text>
          </View>
        </View>
        <View style={{ marginVertical: 16 }}>
          <Text style={styles.description}>
            ...
            exercitation ullamco laboris nisi ut aliquip. Sed ut perspiciatis unde omnis iste natus
