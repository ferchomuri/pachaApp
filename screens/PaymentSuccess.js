...
const PaymentSuccess = ({ navigation }) => {
  return (
    <SafeAreaView style={{ flex: 1, backgroundColor: COLORS.white }}>
      ...
      <View
        style={{ flex: 1, alignItems: 'center', justifyContent: 'center', marginHorizontal: 16 }}
      >
        <Image
          source={illustrations.orderConfirmed}
          resizeMode="contain"
          style={{
        ...
        >
          <Button filled title="CONTINUE" onPress={() => navigation.navigate('Home')} />
        </View>
      </View>
    </SafeAreaView>
  );
