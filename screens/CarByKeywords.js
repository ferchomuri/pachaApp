...
import { products, suggestedShops } from '../data/utils';
  ...
  const renderProducts = () => {
    ...
    return (
      <View style={{ marginVertical: 22 }}>
        <Text style={{ ...FONTS.body3, marginBottom: 12 }}>Popular Cars</Text>
        <View
          style={{
            flexDirection: 'row',
            flexWrap: 'wrap',
        ...
        >
          {products.map((item, index) => (
            ...
            >
              ...
              />
              <Text style={{ fontSize: 14, fontFamily: 'bold', marginVertical: 4 }}>
                {item.name}
              </Text>
              <Text style={{ fontSize: 13, fontFamily: 'regular', marginVertical: 4 }}>
                {item.shopName}
              </Text>
              <View
                style={{
        ...
        <FlatList
          ...
          renderItem={({ item, index }) => (
            ...
            >
              ...
              />
              <Text style={{ fontSize: 18, fontFamily: 'regular', marginVertical: 6 }}>
                {item.name}
              </Text>
              <View style={{ marginBottom: 4, flexDirection: 'row' }}>
                {item.keywords.map((keyword, index) => (
                  <Text
                    key={index}
                    style={{ fontSize: 14, color: COLORS.gray5, textTransform: 'capitalize' }}
                  >
                    {keyword}
              ...
              <View style={{ flexDirection: 'row' }}>
                ...
                <View style={{ flexDirection: 'row', alignItems: 'center' }}>
                  ...
                  <Text style={{ marginLeft: 8 }}>{item.deliveryTime} days</Text>
                </View>
              </View>
            </TouchableOpacity>
          )}
