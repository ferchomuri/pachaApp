...
const ResetPassword = ({ navigation }) => {
  ...
  return (
    <ImageBackground source={images.background3} style={{ flex: 1, backgroundColor: COLORS.blue }}>
      <StatusBar style="light" />
      <View style={commonStyles.header}>
        <TouchableOpacity onPress={() => navigation.goBack()} style={commonStyles.backIcon}>
          <MaterialIcons name="keyboard-arrow-left" size={24} color={COLORS.black} />
        </TouchableOpacity>
        <Text style={commonStyles.headerTitle}>Reset Password</Text>
        <Text style={commonStyles.subHeaderTitle}>Please reset your password to get started</Text>
      </View>
