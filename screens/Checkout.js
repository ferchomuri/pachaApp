    ...
    return (
      <View>
        ...
        >
          <View style={styles.shippingLeftContainer}>
            <View style={styles.gpsIconContainer}>
              <Image source={icons.gps} resizeMode="contain" style={styles.gpsIcon} />
            </View>
            <View
              style={{
                marginLeft: 12,
        ...
        <View style={styles.orderContainer}>
          <Image source={images.car9} resizeMode="cover" style={styles.carImage} />
          <View
            style={{
              marginLeft: 12,
            }}
        ...
        >
          ...
          >
            <Image source={icons.car} resizeMode="contain" style={styles.carIcon} />
